...
import { Briefcase, Sprout, ChevronDown } from "lucide-react"
                  ...
                  <div className="space-y-3 h-full">
                    {displayEvents.map((event, idx) => {
                      ...
                      return (
                          ...
                          >
                            <span className="text-xs font-semibold text-[#111827] truncate block">
                              {isGrowth ? event.title : getDisplayCompanyName(event.title, isMasked)}
                            </span>
                            <p className="text-[11px] text-[#6B7280] truncate mt-1">{event.subtitle}</p>
